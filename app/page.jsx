...
import Testimonial from "../components/hero/Testimonials";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen py-20">
      <header className="md:flex md:gap-12 sm:gap-4 sm:mx-auto sm:grid sm:grid-cols-1 sm:justify-center sm:items-center sm:p-2 sm:text-base mx-10 w-full mb-10 max-w-[85rem] bg-transparent">
        ...
        <aside className="w-full md:max-w-[44rem] p-2">
          ...
          <div className="flex gap-10 text-[1.5rem] sm:p-2 sm:mt-6 sm:justify-center sm:w-full">
            <Link href='/shop' className="inline-block mt-3 md:p-3 sm:p-2 border border-gray-800 hover:border-amber-600 rounded-md text-[#ddd6cb] font-bold hover:text-amber-600 first:bg-transparent first:text-[#ff9b05]">Shop With Us</Link>
            <Link href='/services' className="inline-block mt-3 md:p-3 sm:p-2 border border-gray-800 hover:border-amber-600 rounded-md text-[#ddd6cb] font-bold hover:text-amber-600">Get Started</Link>
          </div>
