...
export default function About() {
    return (
        <>
            <section className="bg-transparent flex flex-col space-y-10">
                <h2 className="text-[2rem] tracking-wide text-center text-amber-600">More About Sofa Lux</h2>
                <div className="grid md:grid-cols-2 gap-10">
                    {/* info side */}
                    <div className="flex flex-col mx-10">
                        {/* <h2 className="text-xl tracking-wide text-center">Discover the comfort and style your living room and office with our exclusive variety of sofas</h2> */}
                        <article className="flex flex-col items-center p-4 bg-gray-950 max-w-[70rem] shadow-sm shadow-gray-600 rounded-sm mt-4 justify-center sm:p-8 w-full">
                        ...
                        <div className="flex text-[1.5rem] p-2 mt-6 sm:justify-start sm:w-full">
                            <Link href='/pricing' className="inline-block mt-3 p-2 rounded-md text-amber-600 border border-gray-600 font-bold hover:text-[#ddd6cb] hover:bg-gradient-to-r from-black to-amber-600">Get Started</Link>
                        </div>
