                ...
                <nav className='w-full flex items-center p-1 justify-between pr-0'>
                    ...
                    <div className={`${openMenu ? 'fixed inset-0 flex flex-col items-center sm:border-r sm:rounded-sm sm:my-2 sm:border-amber-900 w-1/3 bg-gray-950 bg-opacity-75 z-100 transition-all duration-200' : 'hidden'}  md:flex md:flex-row md:outline-none md:items-center md:justify-between md:w-auto`}>
                        <ul className='flex flex-col font-montserrat p-8 pr-10 mt-6 md:flex-row md:space-x-12 sm:space-y-10 '>
                            <li onClick={closeNav} className="hover:translate-x-2"><Navlink href='/'>Home</Navlink></li>
                            <li onClick={closeNav} className="hover:translate-x-2"><Navlink href='/about'>About</Navlink></li>

                            <li className="group relative" onClick={closeNav}>
                                <Navlink href="/services" className="block py-2 px-4 hover:translate-x-2">Services</Navlink>
                            ...
                            <li onClick={closeNav} className="hover:translate-x-2"><Navlink href='/testimonials'>Testimonials</Navlink></li>
                            <li onClick={closeNav} className="hover:translate-x-2"><Navlink href='/contact'>Contact</Navlink></li>
                            <li onClick={closeNav} className="hover:translate-x-2"><Navlink href='/shop'>Shop</Navlink></li>
                        </ul>
                    </div>
                </nav>
            </header>
